    ...
    <div class="px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div class="flex items-center space-x-3">
          ...
          <Help align="right" />
          <ThemeToggle />
          <router-link to="/settings" class="px-3 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center text-sm text-gray-700 dark:text-gray-200">Configuración</router-link>
          <router-link to="/" class="px-3 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center text-sm text-gray-700 dark:text-gray-200">Juego</router-link>
          <!-- Divider -->
